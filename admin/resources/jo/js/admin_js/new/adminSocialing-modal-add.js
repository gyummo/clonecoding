...
/*----------------------*/
var load_prod_list = function () {
    SHOP_PROD_LIST.loadList('1', { 'status': 'all', 'prod_name': '', 'category': '', 'showcase': '', 'pagesize': 20, 'search_keyword_type': '' }, "/admin/shopping/product/?q=YToxOntzOjY6InN0YXR1cyI7czozOiJhbGwiO30%3D");
};

$(function () {
    SHOP_PROD_LIST.init();
    SHOP_PROD_MANAGE.addUnitData('u20240516664558215af61', 'KR', '₩', ',', '.', 0);
    SHOP_PROD_MANAGE.setDefaultUnitCode('u20240516664558215af61');
    SHOP_PROD_MANAGE.setCurrentUnitCode('u20240516664558215af61');
    load_prod_list();
    SHOP_PROD_MANAGE.loadCategoryList(function () {
        $('#prod_list_category_').addClass('active');
    }, true, 'prod_list');
});
