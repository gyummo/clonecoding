    ...
    if (svShowAnalyticsTooltip === 'Y') {
        ...
        function appendTooltip() {
            ...
            setTimeout(() => {
                ...
                var arrowSvg = `<img style="position: absolute;left: -6px;top: 50%;transform: translateY(-50%);" width="6" height="12" viewBox="0 0 6 12" fill="none" src="http://www.w3.org/2000/svg"/>`
