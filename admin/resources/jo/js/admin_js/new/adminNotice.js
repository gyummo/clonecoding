...
/*----------------------*/
function searchPost() {
    var url = ADMIN_URL + "contents/calendar?";
...
$(function () {
    ...
    let board_code = ''; let board_type = 'calendar'; let base_url = '/admin/contents/calendar/?q=YToxOntzOjk6ImlkeF9vcmRlciI7czo0OiJkZXNjIjt9'; let board_keyword = ``; let params = [board_code, board_type, base_url, board_keyword];        /**
...
$(document).ready(function () {
    ...
    adminContents.setChangeListSort('calendar', $("._sortable_list"));
});
