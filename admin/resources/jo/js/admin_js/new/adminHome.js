...
var lineChartData = {
    ...
    datasets: [{
        label: "페이지뷰",
        fillColor: "rgba(193,231,255,0.7)",
        strokeColor: "rgba(193,231,255,1)",
        pointColor: "rgba(193,231,255,1)",
        ...
        label: "방문자",
        fillColor: "rgba(94,206,255,0.3)",
        strokeColor: "rgba(94,206,255,1)",
        pointColor: "rgba(26,109,255,1)",
        pointStrokeColor: "#fff",
        pointHighlightFill: "#fff",
